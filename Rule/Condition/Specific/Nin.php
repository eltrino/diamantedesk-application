...
class Nin extends AbstractCondition
{
    ...
    public function __construct($property, $value)
    {
        ...
        list($this->rangeStart, $this->rangeEnd) = explode(',', str_replace(' ', '',$value));
    }
    ...
    public function isSatisfiedBy(Fact $fact)
    {
        ...
        return ($actualValue < $this->rangeStart || $actualValue > $this->rangeEnd);
    }
}