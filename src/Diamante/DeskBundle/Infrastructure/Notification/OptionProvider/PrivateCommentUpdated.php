...
class PrivateCommentUpdated extends OptionsProvider implements OptionsProviderInterface
{
    /**
     * @return string
     */
    ...
    {
        return 'private_comment_updated';
    }
    ...
    {
        return 'diamante.desk.automation.notification.comment.private.updated';
    }
