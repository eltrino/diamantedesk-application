...
class PrivateCommentCreated extends OptionsProvider implements OptionsProviderInterface
{
    /**
     * @return string
     */
    ...
    {
        return 'private_comment_created';
    }
    ...
    {
        return 'diamante.desk.automation.notification.comment.private.created';
    }
