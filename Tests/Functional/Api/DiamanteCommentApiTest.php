...
class DiamanteCommentApiTest extends ApiTestCase
{
    /**
     * @var ApiCommand
     */
    ...
    public function testCreateComment()
    {
        ...
        $response = $this->post('diamante_comment_api_service_diamante_post_new_comment_for_ticket', $this->command);
    ...
    {
        $this->getAll('diamante_comment_api_service_diamante_list_all_comments');
    }
    ...
    public function testGetComment($comment)
    {
        ...
        $this->get('diamante_comment_api_service_diamante_load_comment', $this->command);
    }
    ...
    public function testUpdateComment($comment)
    {
        ...
        $this->put('diamante_comment_api_service_diamante_update_comment_content_and_ticket_status', $this->command);

        $this->command->urlParameters = array('id' => $comment['id']);
        $this->command->requestParameters['content'] = 'Test Ticket Updated PATCH';
        $this->patch('diamante_comment_api_service_diamante_update_comment_content_and_ticket_status', $this->command);
    }
        ...
        {
            $this->command->urlParameters = array('id' => $comment['id']);
            $this->delete('diamante_comment_api_service_diamante_delete_ticket_comment', $this->command);
            $this->get('diamante_comment_api_service_diamante_load_comment', $this->command, Codes::HTTP_NOT_FOUND);
        ...
        public function testAddAttachmentToComment($comment)
        {
            ...
            $response = $this->post('diamante_comment_api_service_diamante_add_comment_attachment', $this->command);
        ...
        {
            $this->command->urlParameters = array('id' => $comment['id']);
            $this->get('diamante_comment_api_service_diamante_list_comment_attachment', $this->command);
        }
        ...
        public function testGetCommentAttachment($comment, $attachments)
        {
            ...
            $this->get('diamante_comment_api_service_diamante_get_comment_attachment', $this->command);
        }
        ...
        {
            $this->command->urlParameters = array('commentId' => $comment['id'], 'attachmentId' => $attachments[0]['id']);
            $this->delete('diamante_comment_api_service_diamante_remove_attachment_from_comment', $this->command);
            $this->get('diamante_comment_api_service_diamante_get_comment_attachment', $this->command, Codes::HTTP_NOT_FOUND);
        }
}