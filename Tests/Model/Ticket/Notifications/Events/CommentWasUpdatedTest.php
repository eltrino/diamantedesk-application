...
class CommentWasUpdatedTest extends \PHPUnit_Framework_TestCase
{
    const ID              = 'id';
    ...
    {
        $ticketWasCreated = new CommentWasUpdated(
            self::ID,
            self::TICKET_SUBJECT,
            array(),
        ...
        $this->assertEquals('commentWasUpdated', $ticketWasCreated->getEventName());
    }
} 