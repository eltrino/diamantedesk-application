...
class TicketWasDeletedTest extends \PHPUnit_Framework_TestCase
{
    const ID = 'id';
    ...
    {
        $ticketWasUpdated = new TicketWasDeleted(
            self::ID,
            self::TICKET_SUBJECT,
            array()
        );

        $this->assertEquals('ticketWasDeleted', $ticketWasUpdated->getEventName());
    }
} 