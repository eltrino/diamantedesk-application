...
class AttachmentWasAddedToCommentTest extends \PHPUnit_Framework_TestCase
{
    const ID              = 'id';
    ...
    {
        $ticketWasCreated = new AttachmentWasAddedToComment(
            self::ID,
            self::TICKET_SUBJECT,
            array(),
        ...
        $this->assertEquals('attachmentWasAddedToComment', $ticketWasCreated->getEventName());
    }
}