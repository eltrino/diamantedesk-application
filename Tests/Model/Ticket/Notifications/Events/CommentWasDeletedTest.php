...
class CommentWasDeletedTest extends \PHPUnit_Framework_TestCase
{
    const ID              = 'id';
    ...
    {
        $ticketWasCreated = new CommentWasDeleted(
            self::ID,
            self::TICKET_SUBJECT,
            array(),
        ...
        $this->assertEquals('commentWasDeleted', $ticketWasCreated->getEventName());
    }
} 