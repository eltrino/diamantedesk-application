 ...
 */
namespace Diamante\EmailProcessingBundle\Tests\Model\Processing;

use Diamante\EmailProcessingBundle\Model\Message;
use Diamante\EmailProcessingBundle\Model\Processing\CompositeStrategy;
...
class CompositeStrategyTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $message = new Message(uniqid(), 'DUMMY_MESSAGE_ID', 'DUMMY_SUBJECT', 'DUMMY_CONTENT', 'DUMMY_REFERENCE');
